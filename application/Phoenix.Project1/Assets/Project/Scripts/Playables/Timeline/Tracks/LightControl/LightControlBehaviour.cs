    ...
    public class LightControlBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                ScriptPlayable<LightControlBehaviourData> inputPlayable = (ScriptPlayable<LightControlBehaviourData>)playable.GetInput(i);
                LightControlBehaviourData input = inputPlayable.GetBehaviour();
